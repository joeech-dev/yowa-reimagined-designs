      ...
      <div ref={ref} className="bg-white text-black p-8 max-w-[210mm] mx-auto font-sans text-sm print:p-0 print:shadow-none" style={{ minHeight: "297mm" }}>
        ...
        <div className="flex justify-between items-start mb-8">
          ...
          <div className="text-right">
            <h1 className="text-3xl font-bold text-[hsl(25,90%,48%)] tracking-wide">WORK ORDER</h1>
          </div>
        </div>
        ...
        {/* Title */}
        {data.title && (
          <h2 className="text-center font-bold text-base mb-4 text-[hsl(25,90%,48%)]">{data.title}</h2>
        )}

        {/* Items Table */}
        <table className="w-full mb-6 border-collapse">
          <thead>
            <tr className="bg-[hsl(25,90%,48%)] text-white">
              <th className="text-left p-3 text-xs font-semibold w-12">No</th>
              <th className="text-left p-3 text-xs font-semibold">Task / Deliverable</th>
        ...
        <div className="flex justify-end mb-8">
          <div className="w-64">
            ...
            <div className="flex justify-between py-3 bg-[hsl(25,90%,48%)] text-white px-3 rounded-b">
        ...
        {data.notes && (
          <div className="bg-gray-50 p-4 rounded mb-8">
            <h3 className="font-bold text-sm mb-2 text-[hsl(25,90%,48%)]">Notes / Scope of Work</h3>
...
WorkOrderTemplate.displayName = "WorkOrderTemplate";
